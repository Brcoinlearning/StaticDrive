...
- 如果你要在另一台新 Linux 机器上重复落地，请优先看 [linux-vm-deployment-playbook.md](/Users/mr.hu/Desktop/开发项目/静态网页服务-文件管理/docs/archive/phases/P4-Deployment/02-after-execution/linux-vm-deployment-playbook.md)。
- 如果你要理解本次重建过程中踩过的坑，请看 [vm-rebuild-lessons-learned.md](/Users/mr.hu/Desktop/开发项目/静态网页服务-文件管理/docs/archive/phases/P4-Deployment/02-after-execution/vm-rebuild-lessons-learned.md)。

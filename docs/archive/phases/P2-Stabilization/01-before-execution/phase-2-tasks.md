...
- `docs/archive/phases/P2-Stabilization/01-before-execution/mvp-gap-reassessment.md`
- `docs/archive/phases/P2-Stabilization/01-before-execution/phase-2-3-scope.md`

输出结果：

- [p2-t1-mvp-scope-freeze.md](/Users/mr.hu/Desktop/开发项目/静态网页服务-文件管理/docs/archive/phases/P2-Stabilization/01-before-execution/p2-t1-mvp-scope-freeze.md)

...
echo "[p5-demo-step3] Owner login page       -> $P5_DEMO_OWNER_WEB_BASE_URL/auth/login"
...
echo "[p5-demo-step3] Owner write form page  -> $P5_DEMO_OWNER_WEB_BASE_URL/write"
...
echo "3. Open the /web/write page to simulate Agent string input and create new content directly from the browser."
echo "4. Open the owner list page to show summary / author / createdAt rendering still works."

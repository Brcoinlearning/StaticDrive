...
echo "[p5-demo-step3] Write form page         -> $P5_DEMO_OWNER_WEB_BASE_URL/write"
...
echo "[p5-demo-step3] Public list page        -> $P5_DEMO_PUBLIC_WEB_BASE_URL/list"
...
echo "0. Open the write form page to simulate Agent string write by entering title + markdown body."
...
echo "3. Open the owner list page to browse cards and toggle layout (横条/卡片)."
echo "4. Open the public list page to see the visitor-facing content directory."
echo "5. Open the public detail page or share page URL to verify the same Markdown sample renders correctly for visitors."
echo "6. Open the direct public API only when you want to inspect the raw JSON payload rather than the rendered page."

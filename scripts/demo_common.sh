...
DEMO_OWNER_WEB_BASE_URL="${DEMO_OWNER_WEB_BASE_URL:-http://127.0.0.1:8787/web}"
DEMO_PUBLIC_WEB_BASE_URL="${DEMO_PUBLIC_WEB_BASE_URL:-http://127.0.0.1:8787/web/public}"
DEMO_FILE_PATH="${DEMO_FILE_PATH:-${DEMO_PDF_PATH:-/Users/mr.hu/Desktop/开发项目/静态网页服务-文件管理/2015-2016 第二学期 软件工程 期中试卷.pdf}}"
...
DEMO_OWNER_WEB_BASE_URL='${DEMO_OWNER_WEB_BASE_URL}'
DEMO_PUBLIC_WEB_BASE_URL='${DEMO_PUBLIC_WEB_BASE_URL}'
DEMO_FILE_PATH='${DEMO_FILE_PATH}'
FILE_CONTENT_ID='${FILE_CONTENT_ID:-${PDF_CONTENT_ID:-}}'
FILE_CONTENT_HASH='${FILE_CONTENT_HASH:-${PDF_CONTENT_HASH:-}}'
FILE_ACCESS_URL='${FILE_ACCESS_URL:-${PDF_ACCESS_URL:-}}'
FILE_SHARE_HASH='${FILE_SHARE_HASH:-${PDF_SHARE_HASH:-}}'
FILE_SHARE_URL='${FILE_SHARE_URL:-${PDF_SHARE_URL:-}}'
...
load_demo_state() {
  ...
  export DEMO_FILE_PATH="${DEMO_FILE_PATH:-${DEMO_PDF_PATH:-}}"
  export FILE_CONTENT_ID="${FILE_CONTENT_ID:-${PDF_CONTENT_ID:-}}"
  export FILE_CONTENT_HASH="${FILE_CONTENT_HASH:-${PDF_CONTENT_HASH:-}}"
  export FILE_ACCESS_URL="${FILE_ACCESS_URL:-${PDF_ACCESS_URL:-}}"
  export FILE_SHARE_HASH="${FILE_SHARE_HASH:-${PDF_SHARE_HASH:-}}"
  export FILE_SHARE_URL="${FILE_SHARE_URL:-${PDF_SHARE_URL:-}}"
}
